...
public class And {
  ...
  public And eq(String key, Object value) {
  ...
  public And eqOrNull(String key, Object value) {
    if (isEmpty(key)) {
      return this;
    }
    this.rules.add(new EqType(key, value));
  ...
  public And like(String key, Object value) {
    if (isEmpty(key) || isEmpty(value)) {
      return this;
    }
  ...
  public And likeOrNull(String key, Object value) {
    if (isEmpty(key)) {
      return this;
    }
  ...
  public And likeBegin(String key, Object value) {
    if (isEmpty(key) || isEmpty(value)) {
      return this;
    }
    this.rules.add(new LikeType(key, value + "%"));
  ...
  public And likeBeginOrNull(String key, Object value) {
    if (isEmpty(key)) {
      return this;
    }
    this.rules.add(new LikeType(key, value != null ? value + "%" : null));
  ...
  public And between(String key, Object value1, Object value2) {
