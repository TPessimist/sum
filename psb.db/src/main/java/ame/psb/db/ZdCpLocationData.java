...
public class ZdCpLocationData {
  ...
  public ZdCpLocationData() {
  }

  public ZdCpLocationData(ZdCpLocationData data) {
    this.uuid = data.uuid;
  ...
  @Override
  public ZdCpLocationData clone() {
    return new ZdCpLocationData(this);
  }
