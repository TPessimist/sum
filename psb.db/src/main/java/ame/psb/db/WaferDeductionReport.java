...
public class WaferDeductionReport { //晶圆扣账时报错查询DW数据完善报错内容
  ...
  private String lifnr; //不为空，则表示未上传回货资料

  private String insmk; //为3表示 入库未接收,当前冻结状态

  public WaferDeductionReport() {
  }

  public WaferDeductionReport(WaferDeductionReport data) {
  ...
  @Override
  public WaferDeductionReport clone() {
    return new WaferDeductionReport(this);
  }
