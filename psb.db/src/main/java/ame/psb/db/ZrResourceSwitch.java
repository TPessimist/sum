...
public class ZrResourceSwitch {
  ...
  public ZrResourceSwitch() {
  }

  public ZrResourceSwitch(ZrResourceSwitch data) {
    this.uuid = data.uuid;
  ...
  @Override
  public ZrResourceSwitch clone() {
    return new ZrResourceSwitch(this);
  }
