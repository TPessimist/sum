...
public class PkgLabelCheck {
  ...
  public PkgLabelCheck() {
  }

  public PkgLabelCheck(PkgLabelCheck data) {
  ...
  public boolean equals(Object obj) { //重写equals方法
    ...
    if (this.labelTempInfo.equals(obj.toString())) {
      return true;
    }
    return false;
  }
  ...
  @Override
  public PkgLabelCheck clone() {
    return new PkgLabelCheck(this);
  }
