...
public class WaferHandOverDao {

  private static final String SQL_INS = "INSERT INTO zr_wafer_handover(wafer_bo,handover_log) VALUES (?,?)";

  private static final String SQL_UPD = "UPDATE zr_wafer_handover SET handover_log=? WHERE wafer_bo=?";

  private static final String SQL_SEL = "SELECT wafer_bo,handover_log FROM zr_wafer_handover ";

  private final Connection conn;

  public WaferHandOverDao(Connection conn) {
    this.conn = conn;
  }
  ...
  public int delete(String waferBo) throws SQLException {
    try (PreparedStatement ps = this.conn
        .prepareStatement("DELETE FROM zr_wafer_handover WHERE wafer_bo=?")) {
